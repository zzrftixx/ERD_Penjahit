...
CREATE TABLE `jenis_pakaian` (
  `ID_Jenis_Pakaian` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jenis_pakaian` WRITE;
/*!40000 ALTER TABLE `jenis_pakaian` DISABLE KEYS */;
/*!40000 ALTER TABLE `jenis_pakaian` ENABLE KEYS */;
UNLOCK TABLES;
