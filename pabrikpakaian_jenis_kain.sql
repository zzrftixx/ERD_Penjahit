...
CREATE TABLE `jenis_kain` (
  `ID_Jenis_Kain` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jenis_kain` WRITE;
/*!40000 ALTER TABLE `jenis_kain` DISABLE KEYS */;
/*!40000 ALTER TABLE `jenis_kain` ENABLE KEYS */;
UNLOCK TABLES;
